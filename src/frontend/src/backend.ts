...
import type { ExternalBlob as _ExternalBlob, OrderRecord as _OrderRecord, Rental as _Rental, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async acceptOrder(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createRental(arg0: string, arg1: string, arg2: string, arg3: bigint | null, arg4: string, arg5: string, arg6: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createRental(arg0, arg1, arg2, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteRental(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBuyerOrders(): Promise<Array<[bigint, OrderRecord, ExternalBlob, string, bigint | null]>> {
        if (this.processError) {
            try {
    ...
    async getOwnerOrders(): Promise<Array<[bigint, OrderRecord, string, Principal, string, string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnerOrders();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRental(arg0: string): Promise<Rental> {
        if (this.processError) {
            try {
                const result = await this.actor.getRental(arg0);
                return from_candid_Rental_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getRentals(arg0: bigint, arg1: bigint): Promise<Array<Rental>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRentals(arg0, arg1);
    ...
    async searchRentals(arg0: string): Promise<[bigint, Array<Rental>]> {
        if (this.processError) {
            try {
                const result = await this.actor.searchRentals(arg0);
                return [
                    result[0],
                    from_candid_vec_n20(this._uploadFile, this._downloadFile, result[1])
                ];
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRental(arg0: string, arg1: string, arg2: string, arg3: bigint | null, arg4: string, arg5: string, arg6: ExternalBlob): Promise<Rental> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRental(arg0, arg1, arg2, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg6));
                return from_candid_Rental_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Rental_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Rental): Promise<Rental> {
...
async function from_candid_tuple_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [bigint, _OrderRecord, _ExternalBlob, string, [] | [bigint]]): Promise<[bigint, OrderRecord, ExternalBlob, string, bigint | null]> {
    return [
        value[0],
        value[1],
        await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value[2]),
        value[3],
        from_candid_opt_n7(_uploadFile, _downloadFile, value[4])
    ];
}
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[bigint, _OrderRecord, _ExternalBlob, string, [] | [bigint]]>): Promise<Array<[bigint, OrderRecord, ExternalBlob, string, bigint | null]>> {
    return await Promise.all(value.map(async (x)=>await from_candid_tuple_n13(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Rental>): Promise<Array<Rental>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Rental_n18(_uploadFile, _downloadFile, x)));
}
